...
**Description:**
Critical security misconfiguration detected on http://squareup.com during massive-scale automated security analysis.
...
**Testing Process:**
1. Automated HTTP request sent to http://squareup.com
...
**Technical Evidence:**
```http
GET http://squareup.com HTTP/1.1
Host: squareup.com
