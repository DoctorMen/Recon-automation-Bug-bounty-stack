# DO.CO Security Vulnerability Report - MASSIVE SCALE
...
**Description:**
Critical security misconfiguration detected on http://do.co during massive-scale automated security analysis.
...
**Testing Process:**
1. Automated HTTP request sent to http://do.co
