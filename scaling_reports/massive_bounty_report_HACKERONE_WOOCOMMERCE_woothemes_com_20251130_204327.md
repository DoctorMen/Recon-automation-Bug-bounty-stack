# WOOTHEMES.COM Security Vulnerability Report - MASSIVE SCALE
...
**Description:**
Critical security misconfiguration detected on http://woothemes.com during massive-scale automated security analysis.
...
**Testing Process:**
1. Automated HTTP request sent to http://woothemes.com
...
**Technical Evidence:**
```http
GET http://woothemes.com HTTP/1.1
Host: woothemes.com
