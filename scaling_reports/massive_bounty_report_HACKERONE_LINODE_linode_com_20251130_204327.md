# LINODE.COM Security Vulnerability Report - MASSIVE SCALE

## VULNERABILITY SUMMARY

**Severity:** Medium (CVSS 6.1)  
**CWE:** CWE-693  
**Platform:** HACKERONE_LINODE Bug Bounty Program  
...
**Description:**
Critical security misconfiguration detected on http://linode.com during massive-scale automated security analysis.
...
**Testing Process:**
1. Automated HTTP request sent to http://linode.com
...
**Status:** READY FOR IMMEDIATE SUBMISSION TO HACKERONE_LINODE BUG BOUNTY PROGRAM
