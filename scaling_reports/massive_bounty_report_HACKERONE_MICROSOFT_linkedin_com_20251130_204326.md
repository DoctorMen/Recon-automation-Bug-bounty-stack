# LINKEDIN.COM Security Vulnerability Report - MASSIVE SCALE
...
**Description:**
Critical security misconfiguration detected on http://linkedin.com during massive-scale automated security analysis.
...
**Testing Process:**
1. Automated HTTP request sent to http://linkedin.com
...
**Technical Evidence:**
```http
GET http://linkedin.com HTTP/1.1
Host: linkedin.com
