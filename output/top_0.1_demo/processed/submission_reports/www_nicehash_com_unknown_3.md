...
**Target**: www.nicehash.com
**Endpoint**: `https://www.nicehash.com/.well-known/openapi.json`
**Vulnerability Type**: 
**Severity**: Low
**Confidence**: 30%
**Estimated Value**: $500
...
This report describes a  vulnerability found on www.nicehash.com.

**Affected Endpoint**: `https://www.nicehash.com/.well-known/openapi.json`
...
**Request**:
```http
GET https://www.nicehash.com/.well-known/openapi.json HTTP/1.1
