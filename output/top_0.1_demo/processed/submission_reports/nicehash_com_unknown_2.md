...
**Target**: nicehash.com
**Endpoint**: `https://nicehash.com/.well-known/openapi.json`
**Vulnerability Type**: 
**Severity**: Low
**Confidence**: 30%
**Estimated Value**: $500
...
This report describes a  vulnerability found on nicehash.com.

**Affected Endpoint**: `https://nicehash.com/.well-known/openapi.json`
...
**Request**:
```http
GET https://nicehash.com/.well-known/openapi.json HTTP/1.1
Host: nicehash.com
```
