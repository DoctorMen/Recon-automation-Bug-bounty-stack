...
def scope_verification_guide():
    ...
    print("=" * 60)
    print()
    print("⚠️  CRITICAL: Verify scope BEFORE testing!")
    ...
    print("✅ RAPYD - CONFIRMED IN SCOPE")
    print("   Program: https://bugcrowd.com/engagements/rapyd")
    print("   ✅ LEGAL: Yes (public bug bounty program)")
    print("   ✅ IN SCOPE:")
    ...
    print("✅ MASTERCARD - CONFIRMED IN SCOPE")
    ...
    print("❌ APPLE CDN ENDPOINTS - LIKELY OUT OF SCOPE")
    print("   ❌ LEGAL RISK: Testing without verification")
    print("   ❌ OUT OF SCOPE:")
    ...
    print("❌ PAYPAL CDN ENDPOINTS - LIKELY OUT OF SCOPE")
    print("   ❌ LEGAL RISK: Testing without verification")
    print("   ❌ OUT OF SCOPE:")
    ...
    print("⚠️  ATLASSIAN - NEED VERIFICATION")
    print("   ⚠️  LEGAL RISK: Unknown until verified")
    print("   ⚠️  STATUS:")
    ...
    print("⚠️  KRAKEN - NEED VERIFICATION")
    print("   ⚠️  LEGAL RISK: Unknown until verified")
    print("   ⚠️  STATUS:")
    print("      - Listed in targets.txt")
    ...
    print("❌ DO NOT TEST (Need verification first):")
    ...
    print("=" * 60)
    print()
    print("🎯 FOCUS ON RAPYD (100% SAFE)")
    print()
    print("Why Rapyd:")
    print("   ✅ Confirmed in scope")
    print("   ✅ You have access")
    print("   ✅ Safe harbor protection")
    print("   ✅ Clear testing guidelines")
    ...
    print()
    print("Safe Harbor Protection:")
    print("   ✅ Rapyd: Full safe harbor")
    print("   ⚠️  Mastercard: Partial safe harbor")
    print("   ❌ Out-of-scope testing: NO protection")
    print()
